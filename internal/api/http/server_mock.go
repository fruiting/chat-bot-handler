...
func (m *MockchatBotProcessor) Process(body []byte) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Process", body)
	ret0, _ := ret[0].(error)
	return ret0
}

// Process indicates an expected call of Process.
func (mr *MockchatBotProcessorMockRecorder) Process(body interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Process", reflect.TypeOf((*MockchatBotProcessor)(nil).Process), body)
}
